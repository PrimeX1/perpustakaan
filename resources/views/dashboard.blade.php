...
<div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box bg-red">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $pinjam_banyak[0]->jumlah }} <i class="fa  fa-book"></i></span>
        <div class="progress">
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box bg-yellow">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $anggota[0]->jumlah }} <i class="fa fa-user"></i></span>
  ...
  <div class="col-md-3 col-sm-6 col-xs-12">
    <div class="info-box bg-aqua">
      ...
      <div class="info-box-content">
        ...
        <span class="info-box-number">{{ $p_bulan[0]->jumlah }} <small>buku bulan ini</small></span>
