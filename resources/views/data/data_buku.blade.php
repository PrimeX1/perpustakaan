            ...
            <table id="data" class="table table-bordered table-striped">
                ...
                @foreach($buku as $rsBuku)
                    <tr>
                        ...
                        <a href="{{ url('buku/delete' , $rsBuku->kd_buku) }}" onclick='return confirm("Yakin Mau Dihapus? Nanti judul KOLEKSI BUKUnya Ikut terHAPUS Lo...")'><button class="btn btn-danger btn-flat" ><i class="fa fa-trash"></i></button></a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
