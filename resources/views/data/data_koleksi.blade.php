...
<div class="box">
    ...
    <a href="{{ url('koleksi/add') }}" ><button type="button" class="btn btn-green btn-flat">Tambah</button></a>
    <a href="{{ url('rpt/qrcode_buku') }}" target="blank"><button type="button" class="btn btn-green btn-flat"><i class="fa fa-qrcode" ></i> Print QR Code</button></a>
    </div>
    <div class="box-body">
