  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        @else
        <img src="{{ asset('img/no-image.jpg')}}"  class="img-circle" alt="User Image">
        @endif
        </div>
      ...
      <form action="#" method="get" class="sidebar-form">
        <div class="input-group">
          <input type="text" name="q" class="form-control" id="mySearch" onkeyup="SearchFunction()" placeholder="Search...">
